...
import data from "../data/phonecasedata";
...
export default function Bcaproduct() {
  return (
    <>
    <p class="text-left font-light text-5xl text-gray-900 mt-6 mb-10 hover:underline">Phone Case Super Store</p>
    ...
    <p class="align-middle mt-8 text-zinc-500 font-sans">Showing: 1-16 of 16 </p>
    </>
  );
}
